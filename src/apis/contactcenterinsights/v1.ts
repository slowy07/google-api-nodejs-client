...
export namespace contactcenterinsights_v1 {
  ...
  export class Resource$Projects$Locations$Conversations {
     ...
     *       filter: 'placeholder-value',
     *       // The maximum number of conversations to return in the response. If this value is zero, the service will select a default size. A call might return fewer objects than requested. A non-empty `next_page_token` in the response indicates that more data is available.
